...
<td id="gras"> Login : </td> <td> <form:input type="text" path="login" required="required"/> <br> </td> </tr>
<tr> <td id="gras">Password : </td> <td> <form:input type="password" path="password" required="required"/> <br> </td> </tr>
